  ...
  return (
    <>
      {state === RECORD_PLAYER_STATE.POPUP &&
        <div id={styles.blur} style={{WebkitBackdropFilter: 'blur(2px)'}} onClick={toggleState}/>}
      <div id={styles['sticky-container']} className={state === RECORD_PLAYER_STATE.POPUP ? styles.popup : ''}>
