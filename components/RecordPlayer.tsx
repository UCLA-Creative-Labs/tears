...
export default function RecordPlayer({action, audioPath, imagePath}: RecordPlayerProps): JSX.Element {
  ...
  return (
    <>
      <div id={styles.container}>
        <svg style={{width: ``}}id={styles.vinyl} width="800" height="800" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
